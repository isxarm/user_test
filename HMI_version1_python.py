...
"")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../Downloads/list.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_2.setPixmap(QtGui.QPixmap("../../Downloads/computer-2.png"))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../Downloads/performance.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border:None;}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../Downloads/no-connection.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../Downloads/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../../Downloads/heart-rate-monitor-2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.data_menu_left.setFrameShape(QtWidgets.QFrame.StyledPanel)
        ...
        self.gridLayout_2.setContentsMargins(136, 19, -1, -1)
        ...
        self.gridLayout_3.setContentsMargins(-1, 81, -1, -1)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../../Downloads/settings-2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.monitor_middle.setFrameShape(QtWidgets.QFrame.StyledPanel)
        ...
        self.performance_top.setFrameShape(QtWidgets.QFrame.StyledPanel)
...
"selection-background-color: rgb(255, 255, 255);")
    ...
    def add_plot(self):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../Downloads/settings-2.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def show_plot_settings(self):
        ...
        if dialog.exec_() == QtWidgets.QDialog.Accepted:
            ...
            param, unit, y_range = dialog.get_selected_parameter()
...
class VoltageSettingsDialog(QtWidgets.QDialog):
    ...
    def get_selected_parameter(self):
        if self.voltage_rb.isChecked():
            return "VOLTAGE", "V", (0, 500)
        elif self.current_rb.isChecked():
            return "CURRENT", "A", (0, 100)
        elif self.power_rb.isChecked():
            return "POWER", "W", (0, 1000)
        elif self.motor_load_rb.isChecked():
            return "MOTOR LOAD", "%", (0, 100)
        elif self.frequency_rb.isChecked():
            return "FREQUENCY", "Hz", (0, 100)
        elif self.rpm_rb.isChecked():
            return "RPM", "RPM", (0, 3000)
        elif self.linear_velocity_rb.isChecked():
            return "LINEAR VELOCITY", "m/s", (0, 30)
        elif self.distance_rb.isChecked():
            return "DISTANCE", "m", (0, 1000)
        return "VOLTAGE", "V", (0, 500)  # Default
