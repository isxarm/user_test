...
class MainWindow(QMainWindow, Ui_HMI):
    ...
    def update_gauges(self):
        ...
        if self.ui.gauge_widget1.label == "VOLTAGE":
            self.ui.gauge_widget1.set_speed(self.status_data['volt'])
        elif self.ui.gauge_widget1.label == "CURRENT":
            self.ui.gauge_widget1.set_speed(self.status_data['current'])
        elif self.ui.gauge_widget1.label == "POWER":
            self.ui.gauge_widget1.set_speed(self.status_data['power'])
        elif self.ui.gauge_widget1.label == "MOTOR LOAD":
            self.ui.gauge_widget1.set_speed(self.status_data['motor_factor'])
        elif self.ui.gauge_widget1.label == "FREQUENCY":
            self.ui.gauge_widget1.set_speed(self.status_data['hirz'])
        else:
            # Random value for other parameters
            self.ui.gauge_widget1.set_speed(random.uniform(
                self.ui.gauge_widget1.min_value,
                self.ui.gauge_widget1.max_value
            ))

        # Update gauge 2 (Current)
        if self.ui.gauge_widget2.label == "VOLTAGE":
            self.ui.gauge_widget2.set_speed(self.status_data['volt'])
        elif self.ui.gauge_widget2.label == "CURRENT":
            self.ui.gauge_widget2.set_speed(self.status_data['current'])
        elif self.ui.gauge_widget2.label == "POWER":
            self.ui.gauge_widget2.set_speed(self.status_data['power'])
        elif self.ui.gauge_widget2.label == "MOTOR LOAD":
            self.ui.gauge_widget2.set_speed(self.status_data['motor_factor'])
        elif self.ui.gauge_widget2.label == "FREQUENCY":
            self.ui.gauge_widget2.set_speed(self.status_data['hirz'])
        else:
            # Random value for other parameters
            self.ui.gauge_widget2.set_speed(random.uniform(
                self.ui.gauge_widget2.min_value,
                self.ui.gauge_widget2.max_value
            ))

        # Update gauge 3 (Frequency)
        if self.ui.gauge_widget3.label == "VOLTAGE":
            self.ui.gauge_widget3.set_speed(self.status_data['volt'])
        elif self.ui.gauge_widget3.label == "CURRENT":
            self.ui.gauge_widget3.set_speed(self.status_data['current'])
        elif self.ui.gauge_widget3.label == "POWER":
            self.ui.gauge_widget3.set_speed(self.status_data['power'])
        elif self.ui.gauge_widget3.label == "MOTOR LOAD":
            self.ui.gauge_widget3.set_speed(self.status_data['motor_factor'])
        elif self.ui.gauge_widget3.label == "FREQUENCY":
            self.ui.gauge_widget3.set_speed(self.status_data['hirz'])
        else:
            # Random value for other parameters
            self.ui.gauge_widget3.set_speed(random.uniform(
                self.ui.gauge_widget3.min_value,
                self.ui.gauge_widget3.max_value
            ))

        # Update gauge 4 (RPM)
        if self.ui.gauge_widget4.label == "VOLTAGE":
            self.ui.gauge_widget4.set_speed(self.status_data['volt'])
        elif self.ui.gauge_widget4.label == "CURRENT":
            self.ui.gauge_widget4.set_speed(self.status_data['current'])
        elif self.ui.gauge_widget4.label == "POWER":
            self.ui.gauge_widget4.set_speed(self.status_data['power'])
        elif self.ui.gauge_widget4.label == "MOTOR LOAD":
            self.ui.gauge_widget4.set_speed(self.status_data['motor_factor'])
        elif self.ui.gauge_widget4.label == "FREQUENCY":
            self.ui.gauge_widget4.set_speed(self.status_data['hirz'])
        else:
            # Random value for other parameters
            self.ui.gauge_widget4.set_speed(random.uniform(
                self.ui.gauge_widget4.min_value,
                self.ui.gauge_widget4.max_value
            ))
